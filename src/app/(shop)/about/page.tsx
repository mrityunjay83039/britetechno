  ...
  return (
    <div className="bg-[#FFFFFF] min-h-screen py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        {/* Text Body */}
        <div className="font-sans text-[#1E3A8A] text-sm leading-relaxed space-y-6">
          <p>
          ...
          <div className="bg-[#1E3A8A] text-[#FFFFFF] p-8 my-10 rounded-sm border border-[#1E3A8A]/20 relative overflow-hidden">
            ...
            <h3 className="font-sans text-xl font-medium tracking-wide text-[#1E3A8A] mb-3">Our Core Principles</h3>
            <ul className="space-y-4 font-sans text-xs sm:text-sm text-[#FFFFFF]/80">
              <li>
                <strong className="text-[#1E3A8A] block font-sans tracking-wide uppercase mb-1">1. Masterful Craftsmanship</strong>
              ...
              <li>
                <strong className="text-[#1E3A8A] block font-sans tracking-wide uppercase mb-1">2. Contemporary Sophistication</strong>
                Sculpting relaxed-fit, modern patterns and sharp styles that define ease and elegance in daily life.
              </li>
              <li>
                <strong className="text-[#1E3A8A] block font-sans tracking-wide uppercase mb-1">3. Meticulous Quality</strong>
